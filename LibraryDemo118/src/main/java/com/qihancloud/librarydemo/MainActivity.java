...
public class MainActivity extends TopBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * 是否截断语音识别内容=Whether to cut off the voice recognition content
         */
        ...
        /**
         * 让机器人进入休眠=Let the robot go to sleep
         */
        ...
        /**
         * 监听机器人休眠/唤醒状态=Monitor robot sleep / wake status
         */
        ...
        /**
         * 获取机器人设备ID=Get robot equipment ID
         */
        uidTv.setText(getString(R.string.robot_id) + systemManager.getDeviceId());

        /**
         * 开启、关闭机器人白光灯=Turn on and off the robot white light
         */
        ...
        /**
         * 控制机器人LED灯=Control the robot LED light
         */
        ...
        /**
         * 控制机器人头部运动=Control the robot head movement
         */
        ...
        /**
         * 控制机器人手部运动=Control robot hand movement
         */
        ...
        /**
         * 控制机器人轮子运动=Control the robot wheel movement
         */
        ...
        /**
         * 监听机器人触摸事件=Listen to robot touch events
         */
        ...
        /**
         * 演示在服务中与机器人通讯=Demonstrate communication with the robot in service
         */
...
//                speakStatusTv.setText(speechManager.isSpeaking()?R.string.robot_is_speaking:R.string.robot_isnot_speaking);
        ...
        speakBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                speechManager.startSpeak("这是一段测试语句=This is a test statement");
            }
        });
        ...
        speechManager.setOnSpeechListener(new SpeakListener() {
            ...
            public void onSpeakFinish() {
                speakProgressTv.setText(R.string.synthesis_finish);
            }

            @Override
            public void onSpeakProgress(int percent) {
                speakProgressTv.setText(getString(R.string.current_speak_progress) + percent);
            }
        });
