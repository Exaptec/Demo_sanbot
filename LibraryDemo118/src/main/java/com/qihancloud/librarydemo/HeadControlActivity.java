...
public class HeadControlActivity extends TopBaseActivity {
    ...
    /**
     * 相对运动方向=Relative movement direction
     */
    ...
    /**
     * 相对运动水平方向=Relative movement level
     */
    ...
    /**
     * 相对运动垂直方向=Relative movement in the vertical direction
     */
    ...
    /**
     * 当前相对运动方向=Current relative movement direction
     */
    private byte curRelativeAction;
    /**
     * 当前绝对运动方向=The current absolute direction of movement
     */
    private byte curAbsoluteAction;
    /**
     * 当前相对锁定action=The current relative lock action
     */
    private byte curRelativeLockAction;
    /**
     * 当前绝对锁定action=The current absolute lock action
     */
    private byte curAbsoluteLockAction;
    /**
     * 当前锁定水平方向=The current lock horizontal direction
     */
    private byte curHorizontalLockAction;
    /**
     * 当前锁定垂直方向=Currently locked in vertical orientation
     */
    private byte curVerticalLockAction;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        //屏幕常亮=The screen is always on
    ...
    private void initListener() {
        //相对运动方向下拉框=Relative movement direction drop-down box
        ...
        //绝对运动方向下拉框=Absolute movement direction drop-down box
        ...
        //相对运动锁定下拉框=Relative movement lock drop-down box
        ...
        //相对运动水平方向下拉框=Relative movement horizontal direction drop-down box
        ...
        //相对运动垂直方向下拉框=Vertical movement relative to the drop-down box
        ...
        //绝对角度定位action=Absolute angle positioning action
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            //开始相对运动=Start relative movement
            ...
            case R.id.tv_head_relative_lock_start:
                ...
                break;
            //绝对角度定位=Absolute angle positioning
