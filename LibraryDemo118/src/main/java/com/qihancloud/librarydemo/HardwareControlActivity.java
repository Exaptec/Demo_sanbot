 ...
 * function: 硬件控制=Hardware control
 * <p/>
...
public class HardwareControlActivity extends TopBaseActivity {
    ...
    private void initListener() {
        //白光灯亮度控制，只能在亮的时候控制=White light brightness control, only when the bright control
        ...
        //声源定位回调=Sound source positioning callback
